...
#ifndef LMP_FIX_ADDFORCEXY_H
#define LMP_FIX_ADDFORCEXY_H

#include "fix.h"

namespace LAMMPS_NS {

class FixAddForceXY : public Fix {
 public:
  FixAddForceXY(class LAMMPS *, int, char **);
  ~FixAddForceXY();
  int setmask();
  void init();
  void setup(int);
 ...
 private:
  ...
  double kx,ky;			// SM
  char *kxstr,*kystr;	// SM
  int kxstyle,kystyle,kxvar,kyvar;	// SM
  double *ework;		// SM
