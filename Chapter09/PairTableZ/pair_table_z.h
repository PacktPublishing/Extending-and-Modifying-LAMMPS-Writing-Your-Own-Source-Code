...
PairStyle(tableZ,PairTableZ)

#else

#ifndef LMP_PAIR_TABLEZ_H
#define LMP_PAIR_TABLEZ_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTableZ : public Pair {
 public:
  PairTableZ(class LAMMPS *);
  virtual ~PairTableZ();
  ...
  double a0, a1;					// SM
  double threshold1, threshold2;	// SM
