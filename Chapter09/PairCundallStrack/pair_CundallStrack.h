...
PairStyle(CundallStrack,PairCundallStrack)

#else

#ifndef LMP_PAIR_CUNDALLSTRACK_H
#define LMP_PAIR_CUNDALLSTRACK_H

#include "pair.h"

namespace LAMMPS_NS {

class PairCundallStrack : public Pair {
 public:
  PairCundallStrack(class LAMMPS *);
  virtual ~PairCundallStrack();
